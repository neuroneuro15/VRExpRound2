...
cfg.VR_SPATIAL_NOVELTY_FAMILIAR_POSITION = int(cfg.VR_SPATIAL_NOVELTY_FAMILIAR_POSITION)
cfg.VR_SPATIAL_NOVELTY_NOVEL_POSITION = int(cfg.VR_SPATIAL_NOVELTY_NOVEL_POSITION)
cfg.VR_SPATIAL_NOVELTY_FIXED_POSITION = int(cfg.VR_SPATIAL_NOVELTY_FIXED_POSITION)
